...
export default function Rdv() {
  ...
  return (
    <>
      <NavbarEtudiant />
      <div className="h-[900px] mb-[120px]">
        <h1
          className="font-mulish font-bold text-black text-2xl pt-[170px]"
          style={{
        ...
        <div
          className="absolute p-4 mt-[150px]"
          style={{
        ...
        >
          ...
          <div className="mt-7 flex font-mulish text-black">
            <div className="flex items-center ml-4 mr-4">
              ...
              />
              <label
                className={selectedOption === "cabinet" ? "font-bold" : ""}
              >
                Au Cabinet
              </label>
            </div>
            ...
            <div className="flex items-center ml-8 mr-4">
              ...
              />
              <label
                className={selectedOption === "domicile" ? "font-bold" : ""}
              >
                A Domicile
              </label>
            </div>
